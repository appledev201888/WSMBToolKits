...
Pod::Spec.new do |s|
  ...
  s.name         = "WSMBToolKits"
  s.version      = "0.0.5"
  s.summary      = "A short description of WSMBToolKits."
...
12345567890
  ...
  s.homepage     = "https://github.com/appledev201888/WSMBToolKits"
  ...
  s.source       = { :git => "https://github.com/appledev201888/WSMBToolKits.git", :tag => "#{s.version}" }
